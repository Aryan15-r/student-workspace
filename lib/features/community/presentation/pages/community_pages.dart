                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text('Requires passcode to enter', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 11)),
                          ],
                        ),
                      ],
                    ),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (res != null && mounted) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text(cp.error ?? 'Could not create room'), backgroundColor: AppColors.error),
                      );
                    }
                  },
                  child: const Text('Create Room', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                ),
              ),
            ],
          ),
    ...
    return AdaptiveScaffold(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Student Lounge & Study Rooms', style: AppTextStyles.headlineSmall.copyWith(color: Colors.white)),
          actions: [
            IconButton(
        ...
        body: Consumer<CommunityProvider>(
          builder: (context, cp, _) {
            final publicRooms  = cp.communities.where((c) => !c.isPrivate).toList();
            final privateRooms = cp.communities.where((c) => c.isPrivate).toList();
              ...
              child: Column(
                ...
                children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          TextButton(
                            onPressed: () => LoginPromptDialog.show(context, featureName: 'Study Rooms'),
                      ...
                      children: [
                        const Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text('Join Room by Code', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              child: const Text('Join Room', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 13)),
                            ),
                          ],
                        ),
                      ],
                          ...
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  const Icon(Icons.lock_rounded, size: 16, color: Color(0xFFFBBF24)),
                                  const SizedBox(width: 6),
                                  Text(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        _selectedTab == 0 ? 'Public Study Lounges' : 'Private Passcode Rooms',
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: _showCreateRoomSheet,
                        icon: const Icon(Icons.add, size: 15, color: Color(0xFF818CF8)),
                        label: const Text('New Room', style: TextStyle(color: Color(0xFF818CF8), fontSize: 12, fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                  const SizedBox(height: 14),
                  ...
                  if (cp.isLoading && cp.communities.isEmpty)
                    ...
                    EmptyStateWidget(
                      icon: _selectedTab == 0 ? Icons.forum_outlined : Icons.lock_outline_rounded,
                      title: _selectedTab == 0 ? 'No Public Rooms' : 'No Private Rooms Yet',
...
class _ChatPageState extends State<ChatPage> {
  ...
  void _showInstagramMessageMenu(CommunityMessage message, bool canDelete, bool isRoomAdmin) {
    showModalBottomSheet(
      context: context,
      backgroundColor: const Color(0xFF0F172A),
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(24))),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(message.username ?? 'Student', style: const TextStyle(color: Color(0xFF818CF8), fontSize: 12, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 2),
                  Text(message.content, style: const TextStyle(color: Colors.white, fontSize: 13.5)),
                ],
              ),
            ),
            const SizedBox(height: 16),
            ...
            ListTile(
              ...
              title: const Text('Copy Message Text', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
              onTap: () {
            ...
            if (canDelete)
              ListTile(
                ...
                title: Text(
                  isRoomAdmin && message.userId != Supabase.instance.client.auth.currentUser?.id
                      ? 'Delete Message (Admin)'
                      : 'Delete Message',
                  style: const TextStyle(color: Color(0xFFF87171), fontWeight: FontWeight.w600),
                ),
                onTap: () async {
                  Navigator.pop(ctx);
                  final cp = context.read<CommunityProvider>();
  ...
  void _showDiscordChannelProfile(Channel? channel, Community? community, bool isRoomAdmin) {
    final cp = context.read<CommunityProvider>();
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Center(child: Text(community?.icon ?? '💬', style: const TextStyle(fontSize: 24))),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(community?.name ?? 'Room Profile', style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                            const SizedBox(width: 6),
                            if (community?.isPrivate == true)
                              const Icon(Icons.lock_rounded, size: 14, color: Color(0xFFFBBF24)),
                          ],
                        ),
                        Text('Channel #${channel?.name ?? 'general'}', style: const TextStyle(color: Color(0xFF94A3B8), fontSize: 12)),
                      ],
                    ),
                  ),
                ],
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text('Channel Members', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)),
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                    decoration: BoxDecoration(color: const Color(0xFF1E293B), borderRadius: BorderRadius.circular(10)),
                    child: Text('${cp.channelMembers.length} Members', style: const TextStyle(color: Color(0xFF818CF8), fontSize: 12, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
              const SizedBox(height: 12),
              ...
              ConstrainedBox(
                ...
                child: cp.channelMembers.isEmpty
                    ? const Padding(
                        ...
                        child: Text('No other members in room yet.', style: TextStyle(color: Color(0xFF64748B))),
                      )
                    : ListView.builder(
                        shrinkWrap: true,
                        ...
                        itemBuilder: (_, i) {
                          ...
                          final isAdmin = member.role == 'admin' || member.userId == community?.createdBy;
                          final currentUserId = Supabase.instance.client.auth.currentUser?.id;
                          ...
                          return ListTile(
                            ...
                            leading: CircleAvatar(
                              ...
                              child: Text(
                                (member.username?.isNotEmpty == true ? member.username![0] : 'U').toUpperCase(),
                                style: const TextStyle(color: Color(0xFF818CF8), fontSize: 12, fontWeight: FontWeight.bold),
                              ),
                            ),
                            title: Row(
                              children: [
                                Text(member.username ?? 'Student', style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
                                const SizedBox(width: 8),
                                if (isAdmin)
                                  Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                            ...
                            trailing: (isRoomAdmin && member.userId != currentUserId)
                                ? IconButton(
                                    icon: const Icon(Icons.person_remove_rounded, color: Color(0xFFF87171), size: 18),
                                    onPressed: () async {
                                      final confirm = await showDialog<bool>(
                                        ...
                                        builder: (c) => AlertDialog(
                                          ...
                                          content: Text('Kick ${member.username ?? 'user'} from channel?'),
                                          actions: [
                                      ...
                                      if (confirm == true) {
                                        await cp.kickMember(widget.channelId, member.userId);
                                        setSheetState(() {});
                                      }
                                    },
                                  )
              ...
              if (isRoomAdmin && community != null)
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: const Text('Delete Room & All Chats (Admin)', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    onPressed: () async {
                      final confirm = await showDialog<bool>(
                        context: context,
                        builder: (c) => AlertDialog(
                          backgroundColor: const Color(0xFF0F172A),
                          title: const Text('Delete Entire Room?', style: TextStyle(color: Colors.white)),
                          content: const Text('This will delete the channel, messages, and room for all users permanently.'),
                          actions: [
                            TextButton(onPressed: () => Navigator.pop(c, false), child: const Text('Cancel')),
                            ElevatedButton(
                              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFEF4444)),
                      ...
                      if (confirm == true) {
                        ...
                        final deleted = await cp.deleteRoomAndCommunity(community.id);
                        if (deleted && mounted) {
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: const Text('Leave Channel', style: TextStyle(color: Color(0xFFF87171), fontWeight: FontWeight.bold)),
                    onPressed: () async {
                      Navigator.pop(ctx);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: GestureDetector(
          onTap: () => _showDiscordChannelProfile(channel, community, isRoomAdmin),
          child: Row(
            children: [
              Text('#${channel?.name ?? 'chat'}', style: AppTextStyles.headlineSmall.copyWith(color: Colors.white)),
              const SizedBox(width: 6),
              const Icon(Icons.info_outline_rounded, size: 16, color: Color(0xFF818CF8)),
              if (isRoomAdmin) ...[
                const SizedBox(width: 8),
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.people_alt_rounded, color: Color(0xFF818CF8)),
            onPressed: () => _showDiscordChannelProfile(channel, community, isRoomAdmin),
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return _MessageTile(
                            ...
                            onLongPress: () => _showInstagramMessageMenu(msg, canDelete, isRoomAdmin),
                          );
                        },
                      ),
          ),
