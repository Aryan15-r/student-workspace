                ...
                : SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                              CircleAvatar(
                                ...
                                child: Text(
                                  profile.initials,
                                  style: const TextStyle(color: Color(0xFF818CF8), fontSize: 36, fontWeight: FontWeight.w700),
                                ),
                              ).animate().fadeIn().scale(),
                              const SizedBox(height: 14),
                              Text(profile.displayName, style: AppTextStyles.headlineMedium.copyWith(color: Colors.white)).animate().fadeIn(delay: 100.ms),
                              Text('@${profile.username}', style: const TextStyle(color: Color(0xFF94A3B8), fontSize: 13)).animate().fadeIn(delay: 150.ms),
                            ],
                          ),
                        ),
                        ...
                        // Academic Info Cards
                        const Text('Academic Profile', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                        ...
                        // Settings Section
                        const Text('App & Account Settings', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 12),
                        ...
                        _SettingActionTile(
                          ...
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Local cache cleared! 🧹'), duration: Duration(seconds: 2)),
                            );
                          },
                        ),
                        const SizedBox(height: 10),
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton.icon(
                            ...
                            label: const Text('Sign Out', style: TextStyle(color: Color(0xFFF87171), fontWeight: FontWeight.bold)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const Text('Guest Mode Active', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text('Sign In to Account', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              icon: const Icon(Icons.person_add_rounded, color: Color(0xFF818CF8)),
              label: const Text('Create New Account', style: TextStyle(color: Color(0xFF818CF8), fontWeight: FontWeight.bold, fontSize: 15)),
          ...
          const Align(
            ...
            child: Text('App Information', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
          ),
          const SizedBox(height: 12),
          _SettingActionTile(
          ...
          const Text('StudySpace v1.0.22', style: TextStyle(color: Color(0xFF64748B), fontSize: 12)),
        ],
      ),
    );
  }
...
class _SettingActionTile extends StatelessWidget {
  ...
  const _SettingActionTile({required this.icon, required this.title, required this.subtitle, required this.onTap});
