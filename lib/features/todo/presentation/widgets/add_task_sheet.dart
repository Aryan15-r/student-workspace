        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Task title *', prefixIcon: Icon(Icons.title_rounded, color: AppColors.textMuted)),
            ...
            TextFormField(
              ...
              style: const TextStyle(color: AppColors.textPrimary),
              decoration: const InputDecoration(labelText: 'Notes (optional)', prefixIcon: Icon(Icons.notes_rounded, color: AppColors.textMuted)),
              maxLines: 2,
            ),
            ...
            Wrap(
              ...
              children: AppConstants.taskCategories.map((c) => _SelectChip(
            ...
            const SizedBox(height: 8),
            Row(
              children: AppConstants.taskPriorities.map((p) => Expanded(
                child: Padding(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      _dueDate == null ? 'Due date (optional)' : '${_dueDate!.day}/${_dueDate!.month}/${_dueDate!.year}',
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Add Task', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
              ),
            ),
          ],
        ),
...
class _SelectChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      child: Text(label, style: TextStyle(color: selected ? color : AppColors.textSecondary, fontSize: 13, fontWeight: selected ? FontWeight.w600 : FontWeight.w400), textAlign: TextAlign.center),
    ),
  );
}
